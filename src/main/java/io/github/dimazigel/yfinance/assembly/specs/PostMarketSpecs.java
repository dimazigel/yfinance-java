...
/**
 * After-hours trading: postMarketPrice, postMarketChange, postMarketChangePercent, postMarketTime. Like
 * {@code changePercent} in {@link CoreSpecs}, v7 serves the percent change as a percent and the {@code price}
 * module as a fraction, so only the v7 path carries the {@code PERCENT} override.
 */
public final class PostMarketSpecs {
    ...
    public static final List<FieldSpec> POST_MARKET = List.of(
            ...
            clustered("postMarket", "postMarketChangePercent", RAW, "v7:postMarketChangePercent|PERCENT", "qs:price.postMarketChangePercent"),
